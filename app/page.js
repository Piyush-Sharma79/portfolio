...
import web7 from "../public/77777.png";
...
export default function Home() {
  ...
  return (
    <div
      className={
        darkMode ? "dark relative font-eurostile" : "relative font-eurostile"
      }
    >
      <div className={showForm ? "form" : ""}>
        ...
        <main
          className="dark:bg-[#111827] form:bg-[#000000cc] bg-green-100 px-10 md:px-20 lg:px-40 "
          onClick={closeForm}
        >
          <section className="min-h-screen">
            <nav className="py-10 flex justify-between">
              <h1 className="hidden min-[470px]:block text-xl dark:text-white ">
                Piyush
              </h1>
              <ul className="flex items-center">
                <li>
                  <BsFillMoonStarsFill
                    ...
                    className="cursor-pointer text-2xl dark:invert"
                  />
                </li>
                <li>
                  <Link
                    className="bg-gradient-to-r from-cyan-500 to-teal-500 text-white px-4 py-2 rounded-md ml-8"
                    href="/CV_off_outside.pdf"
                    target="_blank"
                    download
                  >
                    Resume
            ...
            <div className="text-center p-4 ">
              <h1
                className="text-8xl
              py-2 text-teal-600 dark:text-teal-400 font-bold md:text-9xl font-acorn"
              >
                Piyush
              </h1>
              <h3 className="text-3xl font-acorn py-2 text-teal-700 font-semibold dark:text-white">
          ...
          <section>
            <div className="py-3">
              <h3 className="pt-8 py-5 ark:text-white font-acorn text-center mt-2 text-7xl font-bold text-teal-600">
                Things I Do
              </h3>
              <p className="text-md py-2 leading-8 text-gray-80 dark:text-white text-center text-2xl">
                I'm a Full Stack Developer working remotely from New Delhi,
                India.
              </p>
              <p className="dark:text-white text-center text-2xl">
                I have a strong foundation in web development and design and I
                am always looking to learn more and improve my skills.
              </p>
            </div>
            <div className="lg:flex gap-10">
              <div className="text-center shadow-lg p-10 rounded-xl my-10 flex-1 bg-gradient-to-b from-sky-200 to-sky-50 dark:shadow-slate-300">
                ...
                <p className="py-2 text-lg">
                  I create beautiful designs for websites and mobile
                  applications that are easy to use and visually appealing using
                  my frontend skills
                </p>
                <h4 className="py-4 font-acorn text-teal-600 text-xl">
                  Design Tools & frontend frameworks I Use
                </h4>
              ...
              <div className="text-center shadow-lg p-10 rounded-xl my-10 flex-1 bg-gradient-to-b from-sky-200 to-sky-50 dark:shadow-slate-300">
                ...
                <p className="py-2 text-lg">
                  I bulid highly scalable and secure backend for your web
                  applications using Node, Express, and MongoDB or Postgres.
                </p>
                <h4 className="py-4 font-acorn text-teal-600 text-xl">
                  Backend{" "}
                </h4>
          ...
          <section>
            <div>
              ...
              <p className="text-md py-4 leading-8 text-gray-80 dark:text-white text-center text-2xl">
                ...
                websites to large web applications. Here are a few of my recent
                projects. You can find their source code on my
                <a
                  href="https://github.com/Piyush-Sharma79"
            ...
            <div className="flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap">
              <a
                href="https://polls-project-bay.vercel.app/"
                target="_blank"
                className="rounded-[38px] shadow-xl shadow-slate-400 bg-[#bfe1a342] dark:bg-blue-100 basis-1/3 flex-1 flex flex-col dark:shadow-slate-500 pl-11"
              >
                <p className="flex py-2 text-3xl text-center text-teal-800 pt-12 justify-end pr-5 font-acorn">
                  Polls Project
                  <span className="text-lg text-green-600 pl-3 -mb-10">
                    Svelte
                  </span>
                </p>
                <Image
              ...
              <a
                href="https://blogging-ninja.onrender.com/"
                target="_blank"
                className="rounded-[38px] shadow-xl shadow-slate-400 bg-[#bfe1a342] dark:bg-violet-100 basis-1/3 flex-1 flex flex-col dark:shadow-slate-500 pl-11"
              >
                <p className="flex py-2 text-3xl text-center text-teal-800 pt-12 justify-end pr-5 font-acorn">
                  Blog App{" "}
                  <span className="text-lg text-green-600 pl-3 -mb-10">
