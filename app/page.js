    ...
    <div className={darkMode ? 'dark relative' : 'relative'}>
      <div className={showForm ? 'form' : ''}>
        ...
        <main className='dark:bg-[#111827] form:bg-[#000000cc] bg-green-100 px-10 md:px-20 lg:px-40 ' onClick={closeForm}>
          ...
          <section>
            <div>
              <h3 className='text-4xl font-bold py-1 pt-3 text-center text-teal-600'>
                Work
              </h3>
              <p className='text-md py-4 leading-8 text-gray-80 dark:text-white text-center text-xl'>
